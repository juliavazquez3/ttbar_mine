...
if args.notfull:
	...
	for s in samples:
                if args.ssos: path_hist = '/nfs/cms/vazqueze/hists_ttbar/hists/ssos/histstt_v1v2vBWPSSOS_'+s+'.root'
                else: path_hist = '/nfs/cms/vazqueze/hists_ttbar/hists/histstt_v1v2vBWP_'+s+'.root'
                myfile = TFile( path_hist, 'RECREATE' )
