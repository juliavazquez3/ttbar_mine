...
if args.notfull:
	for s in samples:
        ...
        for s in samples:
                if args.ssos: path_hist = '/nfs/cms/vazqueze/hists_ttbar/hists/wqq/ssos/histwqq_v1vBWPSSOS_'+s+'.root'
                else: path_hist = '/nfs/cms/vazqueze/hists_ttbar/hists/wqq/histwqq_v1vBWP_'+s+'.root'
                myfile = TFile( path_hist, 'RECREATE' )
