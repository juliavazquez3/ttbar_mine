...
if args.ssos: filePath = "/nfs/cms/vazqueze/hists_ttbar/hists/wqq/ssos/"
else: filePath = "/nfs/cms/vazqueze/hists_ttbar/hists/wqq/"
...
not_rebin = ["nJetGood_M","nJetGood_E","nMuoninJet_M","nMuoninJet_E","jet_muon_nmu_M","jet_muon_nmu_E","SSOS_M","SSOS_E",
      "nLooseLepton_M","nLooseLepton_E", "muon_jet_tight_M","muon_jet_tight_E","nSV_nobot_M","nSV_nobot_E"]
...
for name in histNames:
  ...
  if args.jets: 
    term= "wqq_total0J_v1vBWP"
  else:
    term= "wqq_totalHT_v1vBWP"
