...
for s in samples:
	...
	df[s] = df[s].Define('jet_bot1_nsv_good_aux','JetSVMult(nJet, JetBotInd, Jet_pt, Jet_eta, Jet_phi, nSV, SV_pt, SV_phi, SV_eta, SV_charge, 0)')
	df[s] = df[s].Define('jet_bot2_nsv_good_aux','JetSVMult(nJet, JetBotInd, Jet_pt, Jet_eta, Jet_phi, nSV, SV_pt, SV_phi, SV_eta, SV_charge, 1)')
	...
	df[s] = df[s].Define('nSV_nobot_aux','nSVtotal(nJet, JetBotInd, JetGoodInd, Jet_pt, Jet_eta, Jet_phi, nSV, SV_pt, SV_phi, SV_eta, SV_charge)')
...
for s in samples:
	...
	hist_second_muon_pt_M[s] = df_muon[s].Histo1D(("second_muon_pt_M","",100,-1,30),"second_muon_pt","weightSSOS")
	hist_second_muon_pt_E[s] = df_electron[s].Histo1D(("second_muon_pt_E","",100,-1,30),"second_muon_pt","weightSSOS")
	hist_second_electron_pt_M[s] = df_muon[s].Histo1D(("second_electron_pt_M","",100,-1,30),"second_electron_pt","weightSSOS")
	hist_second_electron_pt_E[s] = df_electron[s].Histo1D(("second_electron_pt_E","",100,-1,30),"second_electron_pt","weightSSOS")
	...
	hist_jet_muon_mass_M[s] = df_muon[s].Histo1D(("jet_sv_mass_M","",40,0,40),"jet_muon_mass","weightSSOS")
	...
	hist_jet_muon_mass_E[s] = df_electron[s].Histo1D(("jet_sv_mass_E","",40,0,40),"jet_muon_mass","weightSSOS")
	...
	hist_jet_bot1_nsv_good_M[s] = df_muon[s].Histo1D(("jet_bot1_nsv_good_M","",10,0,10),"jet_bot1_nsv_good","weightSSOS")
	hist_jet_bot1_nsv_good_E[s] = df_electron[s].Histo1D(("jet_bot1_nsv_good_E","",10,0,10),"jet_bot1_nsv_good","weightSSOS")
	hist_jet_bot2_nsv_good_M[s] = df_muon[s].Histo1D(("jet_bot2_nsv_good_M","",10,0,10),"jet_bot2_nsv_good","weightSSOS")
	hist_jet_bot2_nsv_good_E[s] = df_electron[s].Histo1D(("jet_bot2_nsv_good_E","",10,0,10),"jet_bot2_nsv_good","weightSSOS")
	...
	hist_sv_jet_sigr_M[s] = df_muon[s].Histo1D(("sv_jet_sigr_M","",100,0,30),"sv_jet_sigr","weightSSOS")
	hist_sv_jet_sigr_E[s] = df_electron[s].Histo1D(("sv_jet_sigr_E","",100,0,30),"sv_jet_sigr","weightSSOS")
...
if mode == "mc":
        for s in samples:
               hist_jet_muon_flavourH_M[s] = df_muon[s].Histo1D(("jet_sv_flavourH_M","",6,0,6),"jet_muon_flavourH","weightSSOS")
               hist_jet_muon_flavourH_E[s] = df_electron[s].Histo1D(("jet_sv_flavourH_E","",6,0,6),"jet_muon_flavourH","weightSSOS")
               hist_jet_notmuon_flavourH_M[s] = df_muon[s].Histo1D(("jet_notsv_flavourH_M","",6,0,6),"jet_notmuon_flavourH","weightSSOS")
               hist_jet_notmuon_flavourH_E[s] = df_electron[s].Histo1D(("jet_notsv_flavourH_E","",6,0,6),"jet_notmuon_flavourH","weightSSOS")
               hist_jet_muon_flavourP_M[s] = df_muon[s].Histo1D(("jet_sv_flavourP_M","",28,-6,22),"jet_muon_flavourP","weightSSOS")
               hist_jet_muon_flavourP_E[s] = df_electron[s].Histo1D(("jet_sv_flavourP_E","",28,-6,22),"jet_muon_flavourP","weightSSOS")
               hist_jet_notmuon_flavourP_M[s] = df_muon[s].Histo1D(("jet_notsv_flavourP_M","",28,-6,22),"jet_notmuon_flavourP","weightSSOS")
               hist_jet_notmuon_flavourP_E[s] = df_electron[s].Histo1D(("jet_notsv_flavourP_E","",28,-6,22),"jet_notmuon_flavourP","weightSSOS")
...
if args.notfull:
	for s in samples:
		if args.ssos: path_hist = '/nfs/cms/vazqueze/ttbaranalisis/hists/SV/ssos/svtt_v1v3v4v5SSOS_'+s+'_range_'+str(args.list[0])+'_'+str(args.list[1])+'.root'
		else: path_hist = '/nfs/cms/vazqueze/ttbaranalisis/hists/SV/svtt_v1v3v4v5_'+s+'_range_'+str(args.list[0])+'_'+str(args.list[1])+'.root'
	...
	for s in samples:
                if args.ssos: path_hist = '/nfs/cms/vazqueze/hists_ttbar/hists/SV/ssos/svtt_v1vBWPSSOS_'+s+'.root'
                else: path_hist = '/nfs/cms/vazqueze/hists_ttbar/hists/SV/svtt_v1vBWP_'+s+'.root'
                myfile = TFile( path_hist, 'RECREATE' )
