...
if args.notfull:
	...
	for s in samples:
                if args.ssos: path_hist = '/nfs/cms/vazqueze/ttbaranalisis/hists/secondjetflavour/SV/ssos/svtt_sjf_v1vBWPSSOS_'+s+'.root'
                else: path_hist = '/nfs/cms/vazqueze/ttbaranalisis/hists/secondjetflavour/SV/svttt_sjf_v1vBWP_'+s+'.root'
                myfile = TFile( path_hist, 'RECREATE' )
