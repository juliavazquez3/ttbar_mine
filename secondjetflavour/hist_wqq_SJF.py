...
if args.ssos: filePath = "/nfs/cms/vazqueze/ttbaranalisis/hists/wqq/botpoint/ssos/"
else: filePath = "/nfs/cms/vazqueze/ttbaranalisis/hists/wqq/botpoint/"

if args.ssos: ssos_add = "SSOS"
else: ssos_add = "" 

term = "histwqq_test2_v1vBWP"
...
histNames.append("jet_1_pt_M")
histNames.append("jet_1_nmu_M")
histNames.append("jet_2_pt_M")
histNames.append("jet_1_eta_M")
histNames.append("jet_2_eta_M")
histNames.append("jet_2_qgl_M")
histNames.append("jet_2_nmu_M")
histNames.append("jet_2_mass_M")
histNames.append("jet_1_pt_E")
histNames.append("jet_1_nmu_E")
histNames.append("jet_2_pt_E")
histNames.append("jet_1_eta_E")
histNames.append("jet_2_eta_E")
histNames.append("jet_2_qgl_E")
histNames.append("jet_2_nmu_E")
histNames.append("jet_2_mass_E")
...
histNames.append("deltaR_jet1_jet2_M")
histNames.append("deltaR_jet1_jet2_E")
histNames.append("deltaeta_jet1_jet2_M")
histNames.append("deltaeta_jet1_jet2_E")
histNames.append("deltaphi_jet1_jet2_M")
histNames.append("deltaphi_jet1_jet2_E")
histNames.append("MET_pt_M")
histNames.append("MET_pt_E")
histNames.append("transverse_massM")
histNames.append("transverse_massE")
histNames.append("tracks_jet1_M")
histNames.append("tracks_jet2_M")
histNames.append("tracks_jet1_E")
histNames.append("tracks_jet2_E")
histNames.append("EMN_jet1_M")
histNames.append("EMC_jet1_M")
histNames.append("EMN_jet1_E")
histNames.append("EMC_jet1_E")
histNames.append("EMtotal_jet1_M")
histNames.append("EMtotal_jet1_E")
...
histNames.append("jet_1_btag_M")
histNames.append("jet_1_btag_E")
histNames.append("jet_2_btag_M")
histNames.append("jet_2_btag_E")
histNames.append("jet_2_deeptagG_M")
histNames.append("jet_2_deeptagG_E")
histNames.append("jet_2_deeptagC_M")
histNames.append("jet_2_deeptagC_E")
...
for name in histNames:
  ...
  samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","ttbar_nocharm","ttbar_charm","ttbarlep_charm","ttbarlep_nocharm","ttbarhad_charm","ttbarhad_nocharm","DY","WZ","ZZ",
  ...
  if args.jets:
    samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","WZ","ZZ","ST_charm","ST_nocharm",
           "DYJ","WjetsJ_charm","WjetsJ_doublecharm","WjetsJ_light","WjetsJ_bottom","ttbarhad_nocharm","ttbarhad_charm","ttbarlep_nocharm","ttbarlep_charm","ttbar_nocharm","ttbar_charm"]
    ...
    samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","DY","WZ","ZZ","ST_charm","ST_nocharm",
           "Wjets_charm","Wjets_doublecharm","Wjets_bottom","Wjets_light","ttbarhad_nocharm","ttbarhad_charm","ttbarlep_nocharm","ttbarlep_charm","ttbar_nocharm","ttbar_charm"]
  ...
  if args.stack:
    ...
    if args.ratio:
      ...
      ratioB.Sumw2()
      ratioB.SetStats(0)
      hTotalB = histT["WW_semi_charm"].Clone('hTotalB')
      for s in samplesB:
        hTotalB.Add(histT[s])
  ...
  if args.jets: 
    term= "wqq_total0J_test2_v1vBWP"
  else:
    term= "wqq_totalHT_test2_v1vBWP"
