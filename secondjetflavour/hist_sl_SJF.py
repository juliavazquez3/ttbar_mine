...
if args.ssos: filePath = "/nfs/cms/vazqueze/ttbaranalisis/hists/secondjetflavour/ssos/"
else: filePath = "/nfs/cms/vazqueze/ttbaranalisis/hists/secondjetflavour/"

if args.ssos: ssos_add = "SSOS"
else: ssos_add = "" 

term = "hist_sjf_v1v2vBWP"
...
samplesHT = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","Wjets1_light","Wjets1_bottom","Wjets1_charm","Wjets1_doublecharm","Wjets2_light","Wjets2_bottom","Wjets2_charm","Wjets2_doublecharm",
	...
	"ttbar_charm_secondjetgluon","ttbar_charm_secondjetstrange","ttbar_charm_secondjetelse","ttbar_charmbottom","ttbar_nocharm",
        "ttbarlep_charm","ttbarlep_nocharm","ttbarhad_charm","ttbarhad_nocharm",
        "DY1","DY2","DY3","DY4","DY5","DY6","DY7","DY8","WZ","ZZ","ST1_charm","ST2_charm","ST3_charm","ST4_charm","ST1_nocharm","ST2_nocharm","ST3_nocharm","ST4_nocharm",
...
#histNames = ["nJetGood_M","jet_bot1_btag_M","jet_bot2_btag_M"]
...
for data_op in datayears:
	...
	lumi[data_op]["ttbar_charm_secondjetgluon"] = lumi[data_op]["ttbar"]
	lumi[data_op]["ttbar_charm_secondjetstrange"] = lumi[data_op]["ttbar"]
	lumi[data_op]["ttbar_charm_secondjetelse"] = lumi[data_op]["ttbar"]
...
for name in histNames:
  ...
  samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","ttbarhad_charm","ttbar_charmbottom","ttbarlep_charm",
        "ttbar_charm_secondjetgluon","ttbar_charm_secondjetstrange","ttbar_charm_secondjetelse","ttbar_nocharm","ttbarlep_nocharm","ttbarhad_nocharm",
  ...
  samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","ttbar_nocharm","ttbar_charm_secondjetgluon","ttbar_charm_secondjetstrange",
    "ttbar_charmbottom","ttbarlep_charm","ttbarlep_nocharm","ttbarhad_charm","ttbarhad_nocharm","DY","WZ","ZZ","ttbar_charm_secondjetelse",
  ...
  colors["ttbar_charm_secondjetgluon"] = (222,90,106)
  colors["ttbar_charm_secondjetstrange"] = (204,255,153)
  colors["ttbar_charm_secondjetelse"] = (204,255,153)
  ...
  if args.jets:
    samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","WZ","ZZ","ST_charm","ST_nocharm",
           "DYJ","WjetsJ_charm","WjetsJ_doublecharm","WjetsJ_light","WjetsJ_bottom","ttbarhad_nocharm","ttbarhad_charm","ttbarlep_nocharm",
           "ttbarlep_charm","ttbar_nocharm","ttbar_charm_secondjetgluon","ttbar_charm_secondjetelse","ttbar_charm_secondjetstrange"]
    ...
    samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","DY","WZ","ZZ","ST_charm","ST_nocharm",
           ...
           "ttbar_charm_secondjetgluon","ttbar_charm_secondjetelse","ttbar_charm_secondjetstrange"]
