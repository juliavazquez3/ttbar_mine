...
if args.ssos: filePath = "/nfs/cms/vazqueze/hists_ttbar/hists/fromJF/wqq/ssos/"
else: filePath = "/nfs/cms/vazqueze/hists_ttbar/hists/fromJF/wqq/"
...
#       "btag_sf_M","btag_sf_E","Br_weight_M","Br_weight_E","Frag_weight_M","Frag_weight_E",
#       "lep_id_sf_M","lep_id_sf_E"
#]
...
for name in histNames:
  ...
  samples = ["ww","ttbar_dl_charm","ttbar_dl_nocharm","ttbar_dh_charm","ttbar_dh_nocharm","zjets","wz",
    "wjets_charm","wjets_doublecharm","wjets_bottom","wjets_light","st_nocharm","st_charm","ttbar_sl_nocharm","ttbar_sl_charm"]
  ...
  ### Recordatorio -> samples = ["ww","ttbar_dl_charm","ttbar_dl_nocharm","ttbar_dh_charm","ttbar_dh_nocharm","zjets","wz",
  ###  "wjets_charm","wjets_doublecharm","wjets_bottom","wjets_light","st_nocharm","st_charm","ttbar_sl_nocharm","ttbar_sl_charm"]
  ...
  leg.AddEntry(histT["ttbar_dl_nocharm"],"Dileptonic top antitop","f")
  leg.AddEntry(histT["zjets"],"Z plus jets","f")
  leg.AddEntry(histT["wjets_charm"],"W plus jets, charm","f")
