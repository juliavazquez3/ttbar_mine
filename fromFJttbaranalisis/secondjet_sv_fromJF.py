...
if mode == "mc":
        for s in samples:
                if (s[0:8] == "ttbar_sl" and s[-6:]=="_charm"):
...
samples = [s for s in samples if not (s[0:8] == "ttbar_sl" and s[-6:]=="_charm")]
...
if args.notfull:
	...
	for s in samples:
                if args.ssos: path_hist = '/nfs/cms/vazqueze/hists_ttbar/hists/fromJF/secondJF/SV/ssos/histfromJF_sv_v1v2vBWPSSOS_'+s+'.root'
                else: path_hist = '/nfs/cms/vazqueze/hists_ttbar/hists/fromJF/secondJF/SV/histfromJF_sv_v1v2vBWP_'+s+'.root'
                myfile = TFile( path_hist, 'RECREATE' )
